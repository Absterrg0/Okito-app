          ...
          <div className="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
            <div className="space-y-3">
              ...
              <p className="text-base text-muted-foreground ">
                You&apos;re part of our early access program. Every feature across Okito is currently <span className="font-semibold text-primary">100% free</span> while we fine-tune the experience. No credit card. No limits. Just build.
              </p>
            </div>
          ...
          <div className="crypto-glass-static rounded-3xl p-8 md:p-10 space-y-8">
            ...
            <div className="crypto-base rounded-2xl px-5 py-6 text-sm text-foreground space-y-3">
              ...
              <p className="text-sm leading-relaxed text-muted-foreground">
                Ship without limits while we finalize our pricing. Your team gets unrestricted access to Okito&apos;s payments, events, and analytics stack—and your feedback shapes the roadmap.
              </p>
            </div>
